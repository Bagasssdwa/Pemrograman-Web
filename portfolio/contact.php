      ...
      <div class="container" data-aos="fade-up">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Bintaro Sektor 3 Street, South Tangerang, IND 1541234</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>Bagassadewa884@gmail.com</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>No HP</h4>
                <p>+62 856 9281 1509<p>
              </div>
            </div>
          </div>
        ...
        <?php
            ...
            if (isset($_POST['submit'])){
                $namaclient = $_POST['name'];
                $emailclient = $_POST['email'];
                $subject = $_POST['subject'];
                $message = $_POST['message'];
                $querySQL = "INSERT INTO contact (id, namaclient, emailclient, subject, message) VALUES (NULL, '$namaclient', '$emailclient', '$subject', '$message')";
