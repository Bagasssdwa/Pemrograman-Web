        ...
        <div class="section-title">
          <h2>Resume</h2>
            ...
            <div class="resume-item">
              <h4>ElEMENTARY SCHOOL PONDOK RANJI II</h4>
              <h5>2008 - 2014</h5>
              <p><em>Pondok Ranji, Ciputat, IND</em></p>
            </div>
            <div class="resume-item">
              <h4>JUNIOR HIGH SCHOOL</h4>
              <h5>2014 - 2017</h5>
              <p><em>Bintaro Sektor 3, South Tangerang, IND</em></p>
            </div>
            <div class="resume-item">
              <h4>SENIOR HIGH SCHOOL</h4>
              <h5>2014 - 2017</h5>
              <p><em>Ciputat, Banten, IND</em></p>
            </div>
            <div class="resume-item">
              <h4>COLLEGE STUDENT</h4>
              <h5>2020 - Present</h5>
              <p><em>BINTARO, SOUTH TANGERANG, IND </em></p>
            </div> 
          </div>
        </div>
