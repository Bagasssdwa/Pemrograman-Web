...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <p>Hello my name is Bagas Sadewa Putra Juniar,I live in South Tangerang,Now i'am 20 years old, I am a student of the Pembangunan Jaya University, I am the class of 2020 with an Informatic Engineering</p>
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>bagassadewa884@gmail.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+62 856 9281 1509</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>South Tangerang, IND</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>PhEmailone:</strong> <span>bagassadewa884@gmail.com</span></li>
    ...
    <section id="facts" class="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="count-box">
              <i class="">100%</i>
              <span data-toggle>Indonesia</span>
              <p>Basic Language</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">JC++ <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Phyton <i class="val">85%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="">Bussines Analyze</a></h4>
            </div>
          </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      Designed by <a href="https://www.instagram.com/bagasssdwa/">Bagassadewa</a>
      </div>
    </div>
  </footer><!-- End Footer -->
